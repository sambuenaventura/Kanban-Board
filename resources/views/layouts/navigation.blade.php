<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 h-full shadow flex-grow sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('boards.index')" :active="request()->routeIs('boards.*') && !request()->routeIs('boards.manageInvitations')">
                        {{ __('Boards') }}
                    </x-nav-link>
                </div>
