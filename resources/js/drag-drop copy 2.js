document.addEventListener("DOMContentLoaded", (event) => {
    const tasks = document.querySelectorAll(".kanban-column li");
    ...
    function dragEnter(e) {
        ...
        const column = this.closest(".flex-1.bg-gray-100.p-4.rounded-lg");
        if (column) {
    ...
    function drop(e) {
        ...
        const targetColumn = this.querySelector(".kanban-column") || this;
